		...
		<view class="container">
			...
			<view class="detail-content">
				...
				<view class="detail-list-item"
					...
					<view class="lable"
						:style='{"width":"auto","fontSize":"28rpx","color":"#06A9FF","textAlign":"left"}'>
						课程类型：</view>
					<view class="text" :style='{"color":"#06A9FF","textAlign":"center","fontSize":"24rpx"}'>
						{{detail.kechengValue}}
					</view>
				</view>
				<view class="detail-list-item"
			...
			<view class="bottom-content cu-bar bg-white tabbar border shop" v-if="detail.statusTypes == 1">
				<view style="text-align: left;display: flex;">
				</view>
				<view style="text-align: right;">

					<button @tap="xuanke" style="margin-right: 10upx;" class="cu-btn bg-red round shadow-blur"
						:style="{width:'auto',borderRadius:'8rpx',height:'80rpx',fontSize:'28rpx',color:'#fff',backgroundColor:btnColor[3],borderColor:btnColor[3]}">选课</button>
				</view>
			</view>
		</view>
		...
		methods: {
			...
			xuanke(){
				...
				let data= {
					...
					xueshengId:_this.user.id,
					xuankeYesnoTypes: 1
				}
				_this.$api.save('xuanke', data);
