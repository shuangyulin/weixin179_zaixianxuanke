                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/zaixianxuanke/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     ...
                     '照片': 'jiaoshiPhoto',
                     '学生姓名': 'xueshengName',
                     '身份证号': 'xueshengIdNumber',
                     '手机号': 'xueshengPhone',
                     '照片': 'xueshengPhoto',
                     '已修学分': 'xueshengYixiu',
                     '应修学分': 'xueshengYingxiu',
                     '用户名': 'username',
                     '角色': 'role',
                     '新增时间': 'addtime',
                //本表字段
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.xueshengYixiu = el.xueshengYixiu;
                            forum.xueshengYingxiu = el.xueshengYingxiu;
                            forum.xueshengDelete = el.xueshengDelete;
